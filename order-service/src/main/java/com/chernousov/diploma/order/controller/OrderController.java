...
public class OrderController {
    ...
    public OrderResponse createOrder(
        ...
        return orderService.createOrder(parseUserHeader(userIdHeader, usernameHeader), request);
    }
    ...
    public List<OrderResponse> myOrders(
        ...
        return orderService.myOrders(parseUserHeader(userIdHeader, usernameHeader));
    }
    ...
    private AuthenticatedUserHeader parseUserHeader(String userIdHeader, String usernameHeader) {
        if (usernameHeader == null || usernameHeader.isBlank()) {
            throw new InvalidUserHeaderException("X-User-Name header is required");
        }

        try {
            return new AuthenticatedUserHeader(Long.parseLong(userIdHeader), usernameHeader);
